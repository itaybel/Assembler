...
@param numberOfLine the number of the current line proccesed in the input file
...
@param DC a pointer to the data counter
@param numberOfLine the number of the current line proccesed in the input file
@param symbol the created symbol of that instruction (if its not NULL, we just throw a warning)
@return 1 if an error occured, 0 otherwise
*/
...
@param IC - a pointer to the IC
@param numberOfLine - the number current line proccesed in the input file
...
this is the funciton which reads the am file, and calls all of the other functions
...
@return symbolTable the created symbol table, NULL if error occured
*/
